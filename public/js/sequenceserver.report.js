...
var Report = React.createClass({
    ...
    shouldShowSidebar: function () {
        return !(this.props.data.queries.length == 1 &&
                 this.props.data.queries[0].hits.length == 0);
    },
    ...
    overview: function () {
        return (
            <div
                ...
                {this.props.data.program_version}
                <br/>
                <br/>
                Databases queried:
                {
                    _.map(this.props.data.querydb, function (db) {
                        return (
                            "\n  " + db.title + "\n    " + db.nsequences
                ...
                <br/>
                Total sequences in queried databases: {this.props.data.stats.nsequences}<br/>
                Total letters in queried databases: {this.props.data.stats.ncharacters}
                <br/>
                <br/>
            </div>
        );
    ...
    /**
     * Renders main content of the report.
     */
    main: function () {
        return (
            <div
                ...
                { this.overview() }
                {
                    _.map(this.props.data.queries, _.bind(function (query) {
                        return (
                            <Query query={query} data={this.props.data} selectHit={this.selectHit}/>
                        );
                    }, this))
                }
            </div>
    ...
    /**
     * Renders side content of the report.
     */
    sidebar: function () {
        return (
            <div
