 ...
 * autodetection of whether the use entered nucleotide or aminoacid sequence --> dynamically updated availability of blast methods
...
* @ruby search.rb@  or @ruby -p 8080 search.rb@       --> commandline will display address of web server (default: "http://localhost:4567":http://localhost:4567)
