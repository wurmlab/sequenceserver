...
x(E);
var da = h({}, E, {dataTransfer: 0});
x(da);
var ea = h({}, z, {relatedTarget: 0});
x(ea);
var fa = h({}, y, {
  animationName: 0,
  elapsedTime: 0,
...
x(fa);
var ha = h({}, y, {clipboardData: function(a) {
...
exports.unstable_concurrentAct = function(a) {
  ...
  if (void 0 === n.unstable_flushAllWithoutAsserting)
  ...
  try {
    ...
    try {
      do
        var g = n.unstable_flushAllWithoutAsserting();
 while (g);
    } finally {
      b();
    }
