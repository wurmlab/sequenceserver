...
# FAQ
 ...
 - __How will I access my SequenceServer?__
   - Through a web browser, at https://any_name_you_can_think_of.sequenceserver.com (with dashes, or underscores or not - as long as noone else is using it. 
 - __I run the aardvarkgenomes.org web site. Could I embed a hosted sequenceserver in my web page?__
   - Yes - this can be done elegantly, using, for example the http://embedresponsively.com/ approach. Please get in touch letting us how many monthly visitors you have or anticipate. 
