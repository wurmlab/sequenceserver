...
(function(process) {
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      var $def = __webpack_require__(12);
      $def($def.P, 'String', {repeat: __webpack_require__(96)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var toInteger = __webpack_require__(22),
          defined = __webpack_require__(20);
      ...
      module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE) {
        ...
        if (DEFAULT) {
          ...
          if (FORCE)
            ...
            $def($def.P + $def.F * __webpack_require__(102), NAME, methods);
        }
      };
    }, function(module, exports) {
      module.exports = {};
      ...
      var $ = __webpack_require__(2),
          IteratorPrototype = {};
      __webpack_require__(30)(IteratorPrototype, __webpack_require__(33)('iterator'), function() {
        return this;
      });
      ...
      $def($def.S + $def.F * !__webpack_require__(108)(function(iter) {
        Array.from(iter);
      ...
      module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
        var Base = __webpack_require__(7)[NAME],
            ...
            proto = C && C.prototype,
            O = {};
        if (!__webpack_require__(3) || typeof C != 'function' || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
      ...
      var setStatics = function(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(16)(Function.call, [][key], length);
        });
      };
