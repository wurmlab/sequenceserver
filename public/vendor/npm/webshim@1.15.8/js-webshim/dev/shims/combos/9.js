...
(function(process) {
  ...
  webshims.register('dom-extend', function($, webshims, window, document, undefined) {
    ...
    ['removeAttr', 'prop', 'attr'].forEach(function(type) {
      ...
      $[type] = function(elem, name, value, pass, _argless) {
        ...
        if (propMethod) {
          ...
          if (curType === 'removeAttr') {
            ...
            return (propMethod.get) ? propMethod.get.call(elem) : propMethod.value;
            ;
      ...
      extendQ[type] = function(nodeName, prop, desc) {
        ...
        var getSup = function(propType, descriptor, oDesc) {
          ...
          if (type == 'prop' && prop == 'value') {
            return function(value) {
              var elem = this;
              return (desc.isVal) ? singleVal(elem, prop, value, false, (arguments.length === 0)) : olds[type](elem, prop, value);
              ;
            };
          }
        ...
        if (desc.value === undefined) {
          if (!desc.set) {
            desc.set = desc.writeable ? getSup('set', desc, oldDesc) : (webshims.cfg.useStrict && prop == 'prop') ? function() {
    ...
    var createPropDefault = function(descs, removeType) {
      ...
      if (!descs.removeAttr) {
        descs.removeAttr = {value: function() {
    ...
    $.extend(webshims, {
      ...
      reflectProperties: function(nodeNames, props) {
        ...
        props.forEach(function(prop) {
          webshims.defineNodeNamesProperty(nodeNames, prop, {prop: {
              set: function(val) {
                $.attr(this, prop, val);
              },
              get: function() {
