...
!(function (t) {
  !(function (e) {
    "object" == typeof exports
      ...
      ? (global.Promise = e())
      : "undefined" != typeof self && (self.Promise = e());
  })(function () {
    var t;
    return (function e(t, n, o) {
    ...
    })(
      {
        1: [
          ...
          { "../lib/Promise": 2, "../lib/decorators/unhandledRejection": 4 },
        ],
        2: [
          function (e, n, o) {
            !(function (t) {
          ...
          { "./Scheduler": 3, "./env": 5, "./makePromise": 7 },
        ],
        3: [
          function (e, n, o) {
            !(function (t) {
          ...
          function (e, n, o) {
            !(function (t) {
              ...
              t(function () {
                function t(t) {
                  var n =
                    "object" == typeof t && null !== t && (t.stack || t.message)
                      ? t.stack || t.message
                      : e(t);
                  return t instanceof Error
                    ? n
                    : n + " (WARNING: non-Error used)";
                }
                function e(t) {
                  var e = String(t);
                  return (
                ...
                return function (t) {
                  ...
                  function d(t) {
                    return "object" != typeof t || null === t
                      ? r(new TypeError("non-iterable passed to race()"))
                      : 0 === t.length
                      ? i()
                      : 1 === t.length
                      ? o(t[0])
                  ...
                  (e.resolve = o),
                    ...
                    (e.prototype.then = function (t, e, n) {
                      ...
                      if (
                        ...
                        ("function" != typeof e && 0 > r)
                      )
                        return new this.constructor(_, o);
                      var i = this._beget(),
                        u = i._handler;
                    ...
                    (_.prototype.when =
                      ...
                      _.prototype.notify =
                      _.prototype.fail =
                      _.prototype._unreport =
                      _.prototype._report =
                        K),
                    (_.prototype._state = 0),
                  ...
                  A(_, b),
                    ...
                    (b.prototype.when = function (t) {
                      this.resolved
                        ? G.enqueue(new T(t, this.handler))
                    ...
                    A(b, g),
                    A(_, q),
                    (q.prototype._state = 1),
                    (q.prototype.fold = function (t, e, n, o) {
                      N(t, e, this, n, o);
                    }),
                  ...
                  var Y = 0;
                  A(_, P),
                    (P.prototype._state = -1),
                    (P.prototype.fold = function (t, e, n, o) {
                      o.become(this);
                    }),
                    (P.prototype.when = function (t) {
                      "function" == typeof t.rejected && this._unreport(),
                        H(t.rejected, this, t.receiver, t.resolver);
                    }),
                    ...
                    (P.prototype._unreport = function () {
                      this.handled ||
                        ((this.handled = !0), G.afterQueue(new C(this)));
                    }),
                    ...
                    (R.prototype.run = function () {
                      this.rejection.handled ||
                        ...
                        I("unhandledRejection", this.rejection) ||
                          e.onPotentiallyUnhandledRejection(
                            this.rejection,
                            this.context
                          ));
                    }),
                    (C.prototype.run = function () {
                      this.rejection.reported &&
                        (I("rejectionHandled", this.rejection) ||
                          e.onPotentiallyUnhandledRejectionHandled(
                            this.rejection
                          ));
                    }),
                    (e.createContext =
